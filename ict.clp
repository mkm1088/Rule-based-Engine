...
(deffunction MAIN::calculate-competency (?working-in-ict
   ...
   (switch ?working-current-job
      (case WorkingYear0to3    then (bind ?work-competency 1))
      (case WorkingYear3to5    then (bind ?work-competency 2))
      (case WorkingYear5to10   then (bind ?work-competency 3))
      (case WorkingYearAbove10 then (bind ?work-competency 4)))
      
   (switch ?it-skills
      (case VeryLow  then (bind ?it-skills 1))
      (case Low  then (bind ?it-skills 2))
      (case Medium  then (bind ?it-skills 3))
      (case High then (bind ?it-skills 4))
      (case VeryHigh then (bind ?it-skills 5)))
         
   ;;; Technical ideal job
   (if (or (= ?it-skills 1) (= ?it-skills 2)) then
      (bind ?competency 3)
   else
      (if (and (= (str-compare ?same-current-job "Yes") 0) (or(= ?work-competency 1) (= ?work-competency 2)) (<> ?ideal-dp 1)) then
         (bind ?competency 4)
      else
         (bind ?competency 3))

      (if (and (= (str-compare ?same-current-job "No") 0) (or(= ?work-competency 1) (= ?work-competency 2))) then
         (bind ?competency 3))

      (if (= ?work-competency 3)  then
         (if (= ?current-dp 1) then
            (bind ?competency 3)
         else
            (bind ?competency 4)))

      (if (= ?work-competency 4) then  
         (if (= ?ideal-dp 5) then
            (bind ?competency 5)
         else
            (bind ?competency 4))))
...
(deffunction MAIN::match-personality (?mind-types 
   ...
   (bind ?largest-v (create$))
   ;; "(mind-types PersonalityI)"
   (bind ?mind-types-i (sub-string 12 13 ?mind-types))
   (bind ?see-things-i (sub-string 12 13 ?see-things))
   (bind ?judge-things-i (sub-string 12 13 ?judge-things))
   (bind ?act-towards-changes-i (sub-string 12 13 ?act-towards-changes))
   ...
   (progn$ (?v ?values)
      ...
      (if (= (str-compare ?mind-types-i ?mind-types-v) 0) then 
         (bind ?count (+ ?count 1)))
      (if (= (str-compare ?see-things-i ?see-things-v) 0) then 
         (bind ?count (+ ?count 1)))
      (if (= (str-compare ?judge-things-i ?judge-things-v) 0) then 
         (bind ?count (+ ?count 1)))
      (if (= (str-compare ?act-towards-changes-i ?act-towards-changes-v) 0) then 
         (bind ?count (+ ?count 1)))
   ...
   (progn$ (?v ?values)
      ...
      (if (= (str-compare ?act-towards-changes-i ?act-towards-changes-v) 0) then 
         (bind ?count_new (+ ?count_new 1)))
      (if (= ?count_new ?largest-count) then 
         (bind ?largest-v (create$ ?largest-v ?v)))

   ;;; return values with largest match
   ?largest-v))
...
(defrule ba-cp-entrant-conclusions ""
   ...
   (bind ?personality-reslut (match-personality ?mind-types 
                                      ...
                                      ?act-towards-changes
                                     (create$ "ISTJ" "ISFJ")))
    (progn$ (?personality ?personality-reslut)                        
       (if (= (str-compare ?personality "ISTJ") 0) then
         (bind ?results (create$ ?results (str-cat (find-text-for-id Job032) ";" 
                              (find-text-for-id Course032) ";" 
                              (find-text-for-id Course077) ";"
                              (find-text-for-id Provider013) ";"
                              (find-text-for-id Provider018)))))
       (if (= (str-compare ?personality "ISFJ") 0) then
         (bind ?results (create$ ?results (str-cat (find-text-for-id Job033) ";" 
                              (find-text-for-id Course032) ";" 
...
(defrule ba-cp-expert-conclusions ""
   ...
   (bind ?personality-reslut (match-personality ?mind-types 
                                     ...
                                     (create$ "ENFJ" "ENTJ" "ESTJ" "ISFJ" 
                                            "ISTJ" "ISTP")))        
   (progn$ (?personality ?personality-reslut)                                            
       (if (= (str-compare ?personality "ENFJ") 0) then
         (bind ?results (create$ ?results (str-cat (find-text-for-id Job039) ";" 
                              (find-text-for-id Course008) ";" 
                              (find-text-for-id Course032) ";"
                              (find-text-for-id Provider015) ";"
                              (find-text-for-id Provider013)))))
       (if (= (str-compare ?personality "ENTJ") 0) then
         (bind ?results (create$ ?results (str-cat (find-text-for-id Job086) ";" 
                              (find-text-for-id Course062) ";" 
                              (find-text-for-id Course079) ";"
                              (find-text-for-id Provider018) ";"
                              (find-text-for-id Provider029)))))
       (if (= (str-compare ?personality "ESTJ") 0) then
         (bind ?results (create$ ?results (str-cat (find-text-for-id Job013) ";" 
                              (find-text-for-id Course094) ";" 
                              (find-text-for-id Course008) ";"
                              (find-text-for-id Provider025) ";"
                              (find-text-for-id Provider014)))))
      (if (= (str-compare ?personality "ISFJ") 0) then
         (bind ?results (create$ ?results (str-cat (find-text-for-id Job089) ";" 
                              (find-text-for-id Course069) ";" 
                              (find-text-for-id Course093) ";"
                              (find-text-for-id Provider018) ";"
                              (find-text-for-id Provider025)))))
      (if (= (str-compare ?personality "ISTJ") 0) then
         (bind ?results (create$ ?results (str-cat (find-text-for-id Job070) ";" 
                              (find-text-for-id Course055) ";" 
                              (find-text-for-id Course069) ";"
                              (find-text-for-id Provider020) ";"
                              (find-text-for-id Provider018)))))
      (if (= (str-compare ?personality "ISTP") 0) then
         (bind ?results (create$ ?results (str-cat (find-text-for-id Job100) ";" 
...
(defrule ba-wwo-expert-conclusions ""
   ...
   (bind ?personality-reslut (match-personality ?mind-types 
                                     ...
                                     (create$ "ISFP")))
   (progn$ (?personality ?personality-reslut)                                  
      (if (= (str-compare ?personality "ISFP") 0) then
         (bind ?results (create$ ?results (str-cat (find-text-for-id Job060) ";" 
...
(defrule ba-d-senior-conclusions ""
   ...
   (progn$ (?personality ?personality-reslut)   
       (if (= (str-compare ?personality "ENTJ") 0) then
         (bind ?results (create$ ?results (str-cat (find-text-for-id Job019) ";" 
                              (find-text-for-id Course065) ";" 
                              (find-text-for-id Course081) ";"
                              (find-text-for-id Provider018) ";"
                              (find-text-for-id Provider018)))))
    (if (= (str-compare ?personality "INTP") 0) then
      (bind ?results (create$ ?results (str-cat (find-text-for-id Job045) ";" 
...
(defrule cc-cp-extrant-conclusions ""
   ...
   (progn$ (?personality ?personality-reslut)   
       (if (= (str-compare ?personality "ISTJ") 0) then
         (bind ?results (create$ ?results (str-cat (find-text-for-id Job025) ";" 
...
(defrule cc-cp-expert-conclusions ""
   ...
   (bind ?personality-reslut (match-personality ?mind-types 
                                     ...
                                     (create$ "ESFJ" "ESFP" "ESTJ" "INTJ"
                                            "ISTJ" "ISTP")))
   (progn$ (?personality ?personality-reslut)
       (if (= (str-compare ?personality "ESFJ") 0) then
         (bind ?results (create$ ?results (str-cat (find-text-for-id Job047) ";" 
       ...
       (if (= (str-compare ?personality "ESFP") 0) then
         (bind ?results (create$ ?results (str-cat (find-text-for-id Job027) ";" 
                              (find-text-for-id Course010) ";" 
                              (find-text-for-id Course066) ";"
                              (find-text-for-id Provider014) ";"
                              (find-text-for-id Provider018)))))  
       (if (= (str-compare ?personality "ESTJ") 0) then
         (bind ?results (create$ ?results (str-cat (find-text-for-id Job024) ";" 
                              (find-text-for-id Course031) ";" 
                              (find-text-for-id Course030) ";"
                              (find-text-for-id Provider013) ";"
                              (find-text-for-id Provider013)))))     
       (if (= (str-compare ?personality "INTJ") 0) then
         (bind ?results (create$ ?results (str-cat (find-text-for-id Job054) ";" 
                              (find-text-for-id Course030) ";" 
                              (find-text-for-id Course096) ";"
                              (find-text-for-id Provider013) ";"
                              (find-text-for-id Provider025)))))
       (if (= (str-compare ?personality "ISTJ") 0) then
         (bind ?results (create$ ?results (str-cat (find-text-for-id Job029) ";" 
                              (find-text-for-id Course047) ";" 
                              (find-text-for-id Course046) ";"
                              (find-text-for-id Provider006) ";"
                              (find-text-for-id Provider006)))))
       (if (= (str-compare ?personality "ISTP") 0) then
         (bind ?results (create$ ?results  (str-cat (find-text-for-id Job085) ";" 
                              (find-text-for-id Course010) ";" 
                              (find-text-for-id Course030) ";"
                              (find-text-for-id Provider014) ";"
                              (find-text-for-id Provider013))))))
...
(defrule cc-cp-senior-conclusions ""
   ...
   (progn$ (?personality ?personality-reslut)                                     
       (if (= (str-compare ?personality "ENFJ") 0) then
         (bind ?results (create$ ?results (str-cat (find-text-for-id Job018) ";" 
                              (find-text-for-id Course029) ";" 
                              (find-text-for-id Course010) ";"
                              (find-text-for-id Provider013) ";"
                              (find-text-for-id Provider014))))))
...
(defrule cc-wwo-expert-conclusions ""
   ...
   (progn$ (?personality ?personality-reslut)
       (if (= (str-compare ?personality "ENFP") 0) then
         (bind ?results (create$ ?results (str-cat (find-text-for-id Job028) ";" 
                              (find-text-for-id Course049) ";" 
                              (find-text-for-id Course010) ";"
                              (find-text-for-id Provider010) ";"
                              (find-text-for-id Provider014)))))  
       (if (= (str-compare ?personality "ESTP") 0) then
         (bind ?results (create$ ?results (str-cat (find-text-for-id Job026) ";" 
                              (find-text-for-id Course010) ";" 
                              (find-text-for-id Course005) ";"
                              (find-text-for-id Provider014) ";"
                              (find-text-for-id Provider009)))))
       (if (= (str-compare ?personality "INFP") 0) then
         (bind ?results (create$ ?results (str-cat (find-text-for-id Job023) ";" 
                              (find-text-for-id Course009) ";" 
                              (find-text-for-id Course006) ";"
                              (find-text-for-id Provider014) ";"
                              (find-text-for-id Provider009)))))
       (if (= (str-compare ?personality "ISFP") 0) then
         (bind ?results (create$ ?results (str-cat (find-text-for-id Job005) ";" 
                              (find-text-for-id Course009) ";" 
                              (find-text-for-id Course031) ";"
                              (find-text-for-id Provider014) ";"
                              (find-text-for-id Provider013))))))
...
(defrule ddm-cp-entrant-conclusions ""
   ...
   (progn$ (?personality ?personality-reslut)
       (if (= (str-compare ?personality "ISFJ") 0) then
         (bind ?results (create$ ?results (str-cat (find-text-for-id Job007) ";" 
                              (find-text-for-id Course046) ";" 
                              (find-text-for-id Course048) ";"
                              (find-text-for-id Provider006) ";"
                              (find-text-for-id Provider010)))))
       (if (= (str-compare ?personality "ESTJ") 0) then
         (bind ?results (create$  ?results (str-cat (find-text-for-id Job038) ";" 
...
(defrule ddm-cp-expert-conclusions ""
   ...
   (progn$ (?personality ?personality-reslut)
       (if (= (str-compare ?personality "ENFJ") 0) then
         (bind ?results (create$ ?results (str-cat (find-text-for-id Job041) ";" 
                              (find-text-for-id Course046) ";" 
                              (find-text-for-id Course076) ";"
                              (find-text-for-id Provider006) ";"
                              (find-text-for-id Provider018)))))
       (if (= (str-compare ?personality "INTJ") 0) then
         (bind ?results (create$ ?results (str-cat (find-text-for-id Job034) ";" 
                              (find-text-for-id Course024) ";" 
                              (find-text-for-id Course076) ";"
                              (find-text-for-id Provider012) ";"
                              (find-text-for-id Provider018)))))
       (if (= (str-compare ?personality "ISFJ") 0) then
         (bind ?results (create$ ?results (str-cat (find-text-for-id Job040) ";" 
...
(defrule ddm-wwo-expert-conclusions ""
   ...
   (progn$ (?personality ?personality-reslut)                                  
       (if (= (str-compare ?personality "INTP") 0) then
         (bind ?results (create$ ?results (str-cat (find-text-for-id Job037) ";" 
                              (find-text-for-id Course024) ";" 
                              (find-text-for-id Course090) ";"
                              (find-text-for-id Provider012) ";"
                              (find-text-for-id Provider001))))))
...
(defrule ddm-d-senior-conclusions ""
   ...
   (progn$ (?personality ?personality-reslut)
       (if (= (str-compare ?personality "INTP") 0) then
         (bind ?results (create$ ?results (str-cat (find-text-for-id Job035) ";" 
                              (find-text-for-id Course076) ";" 
...
(defrule ins-cp-expert-conclusions ""
   ...
   (progn$ (?personality ?personality-reslut)
       (if (= (str-compare ?personality "ENFJ") 0) then
         (bind ?results (create$ ?results (str-cat (find-text-for-id Job065) ";" 
                              (find-text-for-id Course021) ";" 
                              (find-text-for-id Course076) ";"
                              (find-text-for-id Provider005) ";"
                              (find-text-for-id Provider018)))))
       (if (= (str-compare ?personality "INFJ") 0) then
         (bind ?results (create$ ?results (str-cat (find-text-for-id Job069) ";" 
                              (find-text-for-id Course028) ";" 
                           ...
                           (str-cat (find-text-for-id Job093) ";" 
                              ...
                              (find-text-for-id Provider006)))))
       (if (= (str-compare ?personality "INTJ") 0) then
         (bind ?results (create$ ?results (str-cat (find-text-for-id Job083) ";" 
                              (find-text-for-id Course085) ";" 
                              (find-text-for-id Course028) ";"
                              (find-text-for-id Provider030) ";"
                              (find-text-for-id Provider003))
                           (str-cat (find-text-for-id Job022) ";" 
                              ...
                              (find-text-for-id Provider018)))))
       (if (= (str-compare ?personality "ISFJ") 0) then
         (bind ?results (create$ ?results (str-cat (find-text-for-id Job042) ";" 
                              (find-text-for-id Course083) ";" 
                              (find-text-for-id Course084) ";"
                              (find-text-for-id Provider009) ";"
                              (find-text-for-id Provider009)))))
       (if (= (str-compare ?personality "ISTJ") 0) then
         (bind ?results (create$ ?results (str-cat (find-text-for-id Job084) ";" 
                              (find-text-for-id Course085) ";" 
                              (find-text-for-id Course023) ";"
                              (find-text-for-id Provider030) ";"
                              (find-text-for-id Provider011)))))
       (if (= (str-compare ?personality "ISTP") 0) then
         (bind ?results (create$ ?results (str-cat (find-text-for-id Job088) ";" 
                              (find-text-for-id Course085) ";" 
                              (find-text-for-id Course028) ";"
                              (find-text-for-id Provider030) ";"
                              (find-text-for-id Provider003))))))
...
(defrule ins-wwo-entrant-conclusions ""
   ...
   (progn$ (?personality ?personality-reslut)
       (if (= (str-compare ?personality "ESFP") 0) then
         (bind ?results (create$ ?results (str-cat (find-text-for-id Job008) ";" 
...
(defrule ins-wwo-expert-conclusions ""
   ...
   (progn$ (?personality ?personality-reslut)
       (if (= (str-compare ?personality "ENFP") 0) then
         (bind ?results (create$ ?results (str-cat (find-text-for-id Job055) ";" 
                              (find-text-for-id Course033) ";" 
                              (find-text-for-id Course006) ";"
                              (find-text-for-id Provider012) ";"
                              (find-text-for-id Provider009)))))     
       (if (= (str-compare ?personality "ENTJ") 0) then
         (bind ?results (create$ ?results (str-cat (find-text-for-id Job067) ";" 
                              (find-text-for-id Course021) ";" 
                              (find-text-for-id Course090) ";"
                              (find-text-for-id Provider005) ";"
                              (find-text-for-id Provider001))
                           (str-cat (find-text-for-id Job068) ";" 
                              ...
                              (find-text-for-id Provider005) ";"
                              (find-text-for-id Provider001)))))
       (if (= (str-compare ?personality "ENTP") 0) then
         (bind ?results (create$ ?results  (str-cat (find-text-for-id Job087) ";" 
                              (find-text-for-id Course058) ";" 
                              (find-text-for-id Course016) ";"
                              (find-text-for-id Provider018) ";"
                              (find-text-for-id Provider018)))))
       (if (= (str-compare ?personality "ESTJ") 0) then
         (bind ?results (create$ ?results (str-cat (find-text-for-id Job059) ";" 
                              (find-text-for-id Course092) ";" 
                              (find-text-for-id Course073) ";"
                              (find-text-for-id Provider009) ";"
                              (find-text-for-id Provider029)))))
       (if (= (str-compare ?personality "INTP") 0) then
         (bind ?results (create$ ?results (str-cat (find-text-for-id Job049) ";" 
                              (find-text-for-id Course014) ";" 
                              (find-text-for-id Course016) ";"
                              (find-text-for-id Provider001) ";"
                              (find-text-for-id Provider018)))))     
       (if (= (str-compare ?personality "ISFP") 0) then
         (bind ?results (create$ ?results (str-cat (find-text-for-id Job048) ";" 
                              (find-text-for-id Course016) ";" 
                              (find-text-for-id Course058) ";"
                              (find-text-for-id Provider018) ";"
                              (find-text-for-id Provider018))))))
...
(defrule ins-d-entrant-conclusions ""
   ...
   (progn$ (?personality ?personality-reslut)
       (if (= (str-compare ?personality "INFJ") 0) then
         (bind ?results (create$ ?results (str-cat (find-text-for-id Job050) ";" 
                              (find-text-for-id Course016) ";" 
                              (find-text-for-id Course014) ";"
                              (find-text-for-id Provider018) ";"
                              (find-text-for-id Provider001))))))
...
(defrule ins-d-senior-conclusions ""
   ...
   (progn$ (?personality ?personality-reslut)
       (if (= (str-compare ?personality "ENTP") 0) then
         (bind ?results (create$ ?results (str-cat (find-text-for-id Job021) ";" 
                              (find-text-for-id Course058) ";" 
...
(defrule ism-wwo-entrant-conclusions ""
   ...
   (progn$ (?personality ?personality-reslut)      
       (if (= (str-compare ?personality "ESTP") 0) then
         (bind ?results (create$ ?results (str-cat (find-text-for-id Job062) ";" 
                              (find-text-for-id Course060) ";" 
                              (find-text-for-id Course059) ";"
                              (find-text-for-id Provider021) ";"
                              (find-text-for-id Provider018)))))
       (if (= (str-compare ?personality "ESJP") 0) then
         (bind ?results (create$ ?results (str-cat (find-text-for-id Job064) ";" 
                              (find-text-for-id Course061) ";" 
                              (find-text-for-id Course062) ";"
                              (find-text-for-id Provider018) ";"
                              (find-text-for-id Provider018)))))
      (if (= (str-compare ?personality "ESFJ") 0) then
         (bind ?results (create$ ?results (str-cat (find-text-for-id Job081) ";" 
                              (find-text-for-id Course059) ";" 
...
(defrule ism-wwo-expert-conclusions ""
   ...
   (progn$ (?personality ?personality-reslut)                                      
       (if (= (str-compare ?personality "ENFJ") 0) then
         (bind ?results (create$ ?results (str-cat (find-text-for-id Job016) ";" 
                              (find-text-for-id Course040) ";" 
                              (find-text-for-id Course079) ";"
                              (find-text-for-id Provider007) ";"
                              (find-text-for-id Provider029)))))
       (if (= (str-compare ?personality "ENFP") 0) then
         (bind ?results (create$ ?results (str-cat (find-text-for-id Job082) ";" 
                              (find-text-for-id Course040) ";" 
                              (find-text-for-id Course074) ";"
                              (find-text-for-id Provider007) ";"
                              (find-text-for-id Provider018)))))
      (if (= (str-compare ?personality "ENTP") 0) then
         (bind ?results (create$ ?results (str-cat (find-text-for-id Job063) ";" 
                              (find-text-for-id Course062) ";" 
                              (find-text-for-id Course056) ";"
                              (find-text-for-id Provider018) ";"
                              (find-text-for-id Provider018)))))
      (if (= (str-compare ?personality "ESFJ") 0) then
         (bind ?results (create$ ?results (str-cat (find-text-for-id Job072) ";" 
                              (find-text-for-id Course068) ";" 
                              (find-text-for-id Course054) ";"
                              (find-text-for-id Provider018) ";"
                              (find-text-for-id Provider020)))))
      (if (= (str-compare ?personality "ESFP") 0) then
         (bind ?results (create$ ?results (str-cat (find-text-for-id Job071) ";" 
                              (find-text-for-id Course053) ";" 
                              (find-text-for-id Course054) ";"
                              (find-text-for-id Provider020) ";"
                              (find-text-for-id Provider020))))))
...
(defrule ism-d-expert-conclusions ""
   ...
   (progn$ (?personality ?personality-reslut)                               
       (if (= (str-compare ?personality "ENFJ") 0) then
         (bind ?results (create$  ?results (str-cat (find-text-for-id Job014) ";" 
                              (find-text-for-id Course080) ";" 
                              (find-text-for-id Course050) ";"
                              (find-text-for-id Provider029) ";"
                              (find-text-for-id Provider020)))))
       (if (= (str-compare ?personality "ENFP") 0) then
         (bind ?results (create$ ?results (str-cat (find-text-for-id Job061) ";" 
                              (find-text-for-id Course062) ";" 
                              (find-text-for-id Course040) ";"
                              (find-text-for-id Provider018) ";"
                              (find-text-for-id Provider007)))))
      (if (= (str-compare ?personality "ESTJ") 0) then
         (bind ?results (create$ ?results (str-cat (find-text-for-id Job080) ";" 
                              (find-text-for-id Course086) ";" 
                              (find-text-for-id Course090) ";"
...
(defrule ism-d-senior-conclusions ""
   ...
   (progn$ (?personality ?personality-reslut)
       (if (= (str-compare ?personality "ESTP") 0) then
         (bind ?results (create$ ?results (str-cat (find-text-for-id Job044) ";" 
...
(defrule itm-cp-entrant-conclusions ""
   ...
   (progn$ (?personality ?personality-reslut)
       (if (= (str-compare ?personality "ESFP") 0) then
         (bind ?results (create$  ?results (str-cat (find-text-for-id Job012) ";" 
                              (find-text-for-id Course035) ";" 
                              (find-text-for-id Course097) ";"
                              (find-text-for-id Provider017) ";"
                              (find-text-for-id Provider025)))))
      (if (= (str-compare ?personality "INFJ") 0) then
         (bind ?results (create$ ?results (str-cat (find-text-for-id Job095) ";" 
...
(defrule itm-cp-expert-conclusions ""
   ...
   (progn$ (?personality ?personality-reslut)
      (if (= (str-compare ?personality "ENTP") 0) then
         (bind ?results (create$ ?results (str-cat (find-text-for-id Job006) ";" 
                              (find-text-for-id Course038) ";" 
                              (find-text-for-id Course089) ";"
                              (find-text-for-id Provider007) ";"
                              (find-text-for-id Provider001)))))
      (if (= (str-compare ?personality "ESFJ") 0) then
         (bind ?results (create$ ?results (str-cat (find-text-for-id Job043) ";" 
                           ...
                           (str-cat (find-text-for-id Job051) ";" 
                              ...
                              (find-text-for-id Provider018)))))
      (if (= (str-compare ?personality "INFJ") 0) then
         (bind ?results (create$ ?results (str-cat (find-text-for-id Job091) ";" 
                              (find-text-for-id Course097) ";" 
                              (find-text-for-id Course045) ";"
                              (find-text-for-id Provider025) ";"
                              (find-text-for-id Provider006)))))     
       (if (= (str-compare ?personality "INTJ") 0) then
         (bind ?results (create$ ?results (str-cat (find-text-for-id Job096) ";" 
...
(defrule itm-wwo-expert-conclusions ""
   ...
   (progn$ (?personality ?personality-reslut)
       (if (= (str-compare ?personality "ENFJ") 0) then
         (bind ?results (create$ ?results (str-cat (find-text-for-id Job077) ";" 
                              (find-text-for-id Course006) ";" 
                              (find-text-for-id Course087) ";"
                              (find-text-for-id Provider009) ";"
                              (find-text-for-id Provider027)))))
      (if (= (str-compare ?personality "ENTJ") 0) then
         (bind ?results (create$ ?results (str-cat (find-text-for-id Job094) ";" 
                              (find-text-for-id Course064) ";" 
                              (find-text-for-id Course039) ";"
                              (find-text-for-id Provider020) ";"
                              (find-text-for-id Provider007)))))
      (if (= (str-compare ?personality "ENTP") 0) then
         (bind ?results (create$ ?results (str-cat (find-text-for-id Job076) ";" 
                              (find-text-for-id Course070) ";" 
                              (find-text-for-id Course006) ";"
                              (find-text-for-id Provider018) ";"
                              (find-text-for-id Provider009)))))
      (if (= (str-compare ?personality "ESTP") 0) then
         (bind ?results (create$ ?results (str-cat (find-text-for-id Job058) ";" 
                              (find-text-for-id Course007) ";" 
                              (find-text-for-id Course072) ";"
                              (find-text-for-id Provider009) ";"
                              (find-text-for-id Provider018)))))  
      (if (= (str-compare ?personality "INFP") 0) then
         (bind ?results (create$ ?results (str-cat (find-text-for-id Job074) ";" 
                           ...
                           (str-cat (find-text-for-id Job056) ";" 
                              ...
                              (find-text-for-id Provider018)))))
       (if (= (str-compare ?personality "INTP") 0) then
         (bind ?results (create$ ?results (str-cat (find-text-for-id Job057) ";" 
                              (find-text-for-id Course015) ";" 
                              (find-text-for-id Course038) ";"
                              (find-text-for-id Provider001) ";"
                              (find-text-for-id Provider007))))))
...
(defrule itm-d-expert-conclusions ""
   ...
   (progn$ (?personality ?personality-reslut)
       (if (= (str-compare ?personality "ESTP") 0) then
         (bind ?results (create$ ?results (str-cat (find-text-for-id Job073) ";" 
                              (find-text-for-id Course088) ";" 
                              (find-text-for-id Course090) ";"
                              (find-text-for-id Provider027) ";"
                              (find-text-for-id Provider001))))))
...
(defrule itm-d-senior-conclusions ""
   ...
   (progn$ (?personality ?personality-reslut)                                  
       (if (= (str-compare ?personality "ENTP") 0) then
         (bind ?results (create$ ?results (str-cat (find-text-for-id Job020) ";" 
                              (find-text-for-id Course006) ";" 
                              (find-text-for-id Course065) ";"
                              (find-text-for-id Provider009) ";"
                              (find-text-for-id Provider018)))))
      (if (= (str-compare ?personality "ESTP") 0) then
         (bind ?results (create$ ?results (str-cat (find-text-for-id Job075) ";" 
                              (find-text-for-id Course006) ";" 
                              (find-text-for-id Course072) ";"
                              (find-text-for-id Provider009) ";"
                              (find-text-for-id Provider018))))))
...
(defrule ssd-cp-entrant-conclusions ""
   ...
   (progn$ (?personality ?personality-reslut)
       (if (= (str-compare ?personality "ISTJ") 0) then
         (bind ?results (create$ ?results (str-cat (find-text-for-id Job002) ";" 
...
(defrule ssd-cp-expert-conclusions ""
   ...
   (progn$ (?personality ?personality-reslut)
       (if (= (str-compare ?personality "ESFJ") 0) then
         (bind ?results (create$ ?results (str-cat (find-text-for-id Job046) ";" 
                              (find-text-for-id Course044) ";" 
                              (find-text-for-id Course063) ";"
                              (find-text-for-id Provider006) ";"
                              (find-text-for-id Provider020)))))  
       (if (= (str-compare ?personality "ESTJ") 0) then
         (bind ?results (create$ ?results (str-cat (find-text-for-id Job078) ";" 
                              (find-text-for-id Course034) ";" 
                              (find-text-for-id Course018) ";"
                              (find-text-for-id Provider007) ";"
                              (find-text-for-id Provider023)))))     
       (if (= (str-compare ?personality "INTJ") 0) then
         (bind ?results (create$ ?results (str-cat (find-text-for-id Job099) ";" 
                           ...
                           (str-cat (find-text-for-id Job053) ";" 
                              ...
                              (find-text-for-id Provider018)))))        
       (if (= (str-compare ?personality "ISFJ") 0) then
         (bind ?results (create$ ?results (str-cat (find-text-for-id Job030) ";" 
                              (find-text-for-id Course034) ";" 
                              (find-text-for-id Course015) ";"
                              (find-text-for-id Provider007) ";"
                              (find-text-for-id Provider001)))))
       (if (= (str-compare ?personality "ISTJ") 0) then
         (bind ?results (create$ ?results (str-cat (find-text-for-id Job090) ";" 
                              (find-text-for-id Course068) ";" 
                              (find-text-for-id Course043) ";"
                              (find-text-for-id Provider018) ";"
                              (find-text-for-id Provider009)))))
       (if (= (str-compare ?personality "ISTP") 0) then
         (bind ?results (create$ ?results (str-cat (find-text-for-id Job092) ";" 
                              (find-text-for-id Course054) ";" 
                              (find-text-for-id Course043) ";"
                              (find-text-for-id Provider020) ";"
                              (find-text-for-id Provider009))))))
...
(defrule ssd-cp-senior-conclusions ""
   ...
   (progn$ (?personality ?personality-reslut)
       (if (= (str-compare ?personality "ENFJ") 0) then
         (bind ?results (create$ ?results (str-cat (find-text-for-id Job017) ";" 
                              (find-text-for-id Course065) ";" 
                              (find-text-for-id Course081) ";"
                              (find-text-for-id Provider018) ";"
                              (find-text-for-id Provider018))))))
...
(defrule ssd-wwo-expert-conclusions ""
   ...
   (progn$ (?personality ?personality-reslut)                               
       (if (= (str-compare ?personality "ESFP") 0) then
         ...
         (handle-state conclusion ?*target* (find-text-for-id ?*message*) ?results))
       (if (= (str-compare ?personality "INFP") 0) then
         (bind ?results (create$ ?results (str-cat (find-text-for-id Job001) ";" 
                              (find-text-for-id Course087) ";" 
                              (find-text-for-id Course072) ";"
                              (find-text-for-id Provider027) ";"
                              (find-text-for-id Provider018))
                           (str-cat (find-text-for-id Job031) ";" 
                              ...
                              (find-text-for-id Provider007)))))              
       (if (= (str-compare ?personality "INTP") 0) then
         (bind ?results (create$ ?results (str-cat (find-text-for-id Job079) ";" 
                              (find-text-for-id Course018) ";" 
                              (find-text-for-id Course086) ";"
                              (find-text-for-id Provider023) ";"
                              (find-text-for-id Provider024))
                           (str-cat (find-text-for-id Job098) ";" 
                              ...
                              (find-text-for-id Provider021)))))
       (if (= (str-compare ?personality "ISFP") 0) then
         (bind ?results (create$ ?results (str-cat (find-text-for-id Job003) ";" 
